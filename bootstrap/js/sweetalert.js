...
var escapeHtml = function escapeHtml(str) {
  ...
  div.appendChild( window.parent.document.createTextNode(str));
...
var sweetAlertInitialize = function sweetAlertInitialize() {
  ...
  var sweetWrap = window.parent.document.createElement('div');
  sweetWrap.innerHTML = _injectedHTML2['default'];
  console.log(sweetWrap.firstChild)
  debugger;
  
  while (sweetWrap.firstChild) {
    window.parent.document.body.appendChild(sweetWrap.firstChild);
  }
...
var getModal = (function (_getModal) {
  ...
  var $modal = window.parent.document.querySelector(modalClass);
...
var getOverlay = function getOverlay() {
  return  window.parent.document.querySelector(overlayClass);
};
